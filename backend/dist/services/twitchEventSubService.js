...
exports.subscribeToEvents = exports.handleTwitchWebhook = void 0;
...
function verifySignature(req, secret) {
    ...
    const expectedSignature = 'sha256=' + crypto_1.default.createHmac('sha256', secret).update(message).digest('hex');
